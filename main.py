...
axes2.bar(['MORTGAGE', 'OWN', 'RENT'], [count_m/num_m, count_o/num_o, count_r/num_r])

axes2.set_title('Average loan amounts per ownership')
axes2.set_xlabel('Home onwnership')
axes2.set_ylabel('Average loan amounts($)')

axes1.table(rowLabels=[0, 1, 2], colLabels=['home_onwnership', 'loan_amnts'], cellText=[['MORTGAGE', count_m/num_m], ['OWN', count_o/num_o], ['RENT',count_r/num_r]], loc='center')
axes1.set_xticks([])
axes1.set_yticks([])
plt.show()